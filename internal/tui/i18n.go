...
var zhStrings = map[string]string{
	...
	"auth_help2":      " [1] 编辑 prefix • [2] 编辑 proxy_url • [3] 编辑 priority • [4] 切换 cloak • [5] 切换 strict • [6] 切换 everything",
	"no_auth_files":   "  无认证文件",
	"confirm_delete":  "⚠ 删除 %s? [y/n]",
	"deleted":         "已删除 %s",
	"enabled":         "已启用",
	"disabled":        "已停用",
	"auth_cloak_only": "仅 Claude/Anthropic 认证文件支持 cloak 切换",
...
var enStrings = map[string]string{
	...
	"auth_help2":      " [1] Edit prefix • [2] Edit proxy_url • [3] Edit priority • [4] Toggle cloak • [5] Toggle strict • [6] Toggle everything",
	"no_auth_files":   "  No auth files found",
	"confirm_delete":  "⚠ Delete %s? [y/n]",
	"deleted":         "Deleted %s",
	"enabled":         "Enabled",
	"disabled":        "Disabled",
	"auth_cloak_only": "cloak toggles are only available for Claude/Anthropic auth files",
